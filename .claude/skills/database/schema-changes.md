...
| `0013_drop_auth_functions.sql`               | Drops the five Supabase-era authorization functions (`has_permission`, `is_admin`, …); the rules are Drizzle queries in `lib/auth/permissions.ts`.                                                                                                                                                                                                   |
