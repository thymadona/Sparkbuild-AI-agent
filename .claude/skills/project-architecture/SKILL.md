...
| ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Board + tutor** (the only student workspace, `/board/[id]`)                         | `app/board/[id]/page.tsx`, `app/api/projects/[id]/turn/route.ts`                                                                      | `app/board/LiveBoard.tsx`, `useTutor.ts`, `BoardView.tsx`, `Nodes.tsx`, `TaskHeader.tsx`, `HomeworkFooter.tsx`, `Mascot.tsx`                                         | `lib/tutor/`, `lib/board/`, `lib/deepseek.ts`, `hooks/usePythonRunner.ts`, `public/py-worker.js`, `public/py-runtime.py`, `lib/sparky-events.ts`                                                                                                                   |
| **Lessons** (catalog, checks, progress, XP)                                           | `app/lessons/page.tsx`, `app/lessons/[id]/page.tsx`, `app/dashboard/page.tsx`, `app/api/projects/**`                                  | `app/lessons/LessonsClient.tsx`, `LessonDetailClient.tsx`, `app/dashboard/DashboardClient.tsx`, `hooks/use{TaskChecks,RuntimeChecks,AutoComplete,LessonProgress}.ts` | `lib/lessons.ts`, `lib/py-lessons.ts`, `lib/task-checks.ts`, `lib/task-verify.ts`, `lib/task-guard.ts`, `lib/python-checks.ts`, `lib/python-check-client.ts`, `lib/lesson-*.ts`, `lib/starter-file.ts`, `lib/xp.ts`, `lib/player-stats.ts`, `public/templates/py/` |
| **Staff back office** (`/staff/*` live; `/admin/*`, `/teacher/*` are redirect shells) | `app/staff/**/page.tsx`, `app/staff/overview-stats.ts`, `app/api/admin/{classes,students,homework,invoices,schedules,telegram,users}` | `app/staff/**/*Client.tsx`, `components/admin/`, `components/dashboard/`                                                                                             | `lib/auth/permissions.ts`, `lib/dashboard-nav.ts`, `lib/schedule.ts`                                                                                                                                                                                               |
