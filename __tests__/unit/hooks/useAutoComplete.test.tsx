...
const passing: TaskChecks = {
  results: [{ label: 'ok', hint: 'h', passed: true }],
  evaluated: true,
  satisfied: true,
}
const failing: TaskChecks = {
  results: [{ label: 'ok', hint: 'h', passed: false }],
  evaluated: true,
  satisfied: false,
}
...
const setup = (over: Partial<Parameters<typeof useAutoComplete>[0]> = {}) => {
  ...
  const view = renderHook(
    (props: Parameters<typeof useAutoComplete>[0]) => useAutoComplete(props),
    {
