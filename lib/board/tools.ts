...
const TutorNode = BoardNode.options.filter((o) => !['output', 'trace', 'preview'].includes(o.shape.type.value))
...
export const TOOLS: OpenAI.Chat.ChatCompletionTool[] = [
  ...
  fn('board_update', 'Change fields of an existing node, e.g. source or highlightLines.', z.object({ id: NodeId, patch: z.record(z.string(), z.unknown()) })),
