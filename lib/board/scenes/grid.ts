...
export interface GridConfig { w: number; h: number; start: { x: number; y: number; dir: Dir }; gems: [number, number][] }
export interface GridState { x: number; y: number; dir: Dir; gems: [number, number][]; bumped: boolean }
