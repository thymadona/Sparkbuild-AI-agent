...
export default function Navigator({ lesson, code, progress }: NavigatorProps) {
    ...
    <div className="flex h-full flex-col">
      <div className="flex-1 overflow-y-auto p-3 flex flex-col gap-4">
        <div>
          ...
          <div className="h-2.5 rounded-full bg-surface-700" aria-label="Core task progress">
            <div
              className="h-2.5 rounded-full bg-gradient-to-r from-brand-500 to-teal-400 transition-all duration-300"
        ...
        <div className="flex flex-col gap-1.5">
          {lesson.tasks.map((task, index) => {
            ...
            return (
              ...
              >
                <span className={`mt-0.5 shrink-0 flex items-center justify-center rounded-full font-medium h-7 w-7 text-sm ${
