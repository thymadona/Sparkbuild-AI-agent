    ...
    <div className="space-y-8">
      ...
      <div className="flex gap-1 border-b border-gray-800">
        {([
          ...
          { id: 'homework', label: `Homework${waiting.length > 0 ? ` (${waiting.length})` : ''}` },
      ...
      {tab === 'lessons' && <LessonsAccordion classId={classId} lessons={lessonsProgress} />}
