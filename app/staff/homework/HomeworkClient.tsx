...
export default function HomeworkClient({ rows }: { rows: SubmissionRow[] }) {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-xl font-semibold text-gray-100">Homework</h1>
      ...
      {error && (
        <div className="mb-4 rounded-md border border-red-800 bg-red-950 px-3 py-2 text-sm text-red-300">{error}</div>
      )}
