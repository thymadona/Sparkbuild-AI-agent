...
const EYES: Record<MascotState, Rect[]> = {
  idle: [[5, 4, 1, 2], [10, 4, 1, 2]],
  listening: [[5, 4, 1, 3], [10, 4, 1, 3]],
  thinking: [[6, 3, 1, 2], [11, 3, 1, 2]], // looking up and right
  speaking: [[5, 4, 1, 2], [10, 4, 1, 2]],
  celebrating: [[4, 5, 1, 1], [5, 4, 1, 1], [6, 5, 1, 1], [9, 5, 1, 1], [10, 4, 1, 1], [11, 5, 1, 1]], // ^ ^
  puzzled: [[5, 4, 1, 2], [10, 5, 1, 1]], // one eye squints
}
const MOUTH: Rect[] = [[7, 7, 2, 1]]
const DOTS: Rect[] = [[6, 0, 1, 1], [8, 0, 1, 1], [10, 0, 1, 1]]
const QUESTION: Rect[] = [[12, 0, 3, 1], [14, 1, 1, 1], [13, 2, 1, 1], [13, 4, 1, 1]]
const SPARKS: Rect[] = [[1, 1, 1, 1], [14, 2, 1, 1], [2, 4, 1, 1], [0, 3, 1, 1]]
