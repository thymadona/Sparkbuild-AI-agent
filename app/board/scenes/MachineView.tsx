...
const slot =
  'flex min-h-14 min-w-20 items-center justify-center rounded-lg px-3 py-2 font-mono text-lg font-bold'
...
export default function MachineView({
  ...
  return (
    <div
      className="flex items-center justify-center gap-3 rounded-xl bg-[#1f2a2e] p-4"
      role="img"
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="grid size-16 place-items-center rounded-xl bg-sky-700 text-3xl"
      >
        ⚙️
      </div>
