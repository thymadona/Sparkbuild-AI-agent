...
export const fixture: Step[] = [
  {
    ...
    ops: [
      ...
      { op: 'add', pageId: 'p1', node: { id: 'h1', parentId: null, createdBy: T, type: 'heading', text: 'Make it talk' } },
    ],
  },
  {
  ...
  },
  {
    ...
    client: [{ op: 'add', pageId: 'p1', node: { id: 'o1', parentId: null, createdBy: 'system', type: 'output', forNodeId: 'c1', stdout: 'hello\n', stderr: '', ok: true } }],
    ops: [{ op: 'focus', id: 'o1' }],
    wait: 1200,
  },
  {
    ...
    ops: [
      ...
      { op: 'add', pageId: 'p2', node: { id: 'h2', parentId: null, createdBy: T, type: 'heading', text: 'A variable is a box' } },
      { op: 'add', pageId: 'p2', node: { id: 't2', parentId: null, createdBy: T, type: 'text', markdown: 'A **variable** holds a value. Give it a name.' } },
    ],
  },
  {
    ...
    ops: [
      ...
      {
        op: 'add', pageId: 'p2',
        node: { id: 'd2', parentId: null, createdBy: T, type: 'diagram', kind: 'variable_boxes', data: { vars: [{ name: 'name', value: '"Mia"' }] } },
      },
    ],
    wait: 1800,
  },
