export default function EditorLoading() {
  return (
    <div className="flex h-screen flex-col bg-surface-900 font-body animate-pulse">
      {/* Top bar */}
      <div className="flex h-12 shrink-0 items-center justify-between border-b border-surface-600 bg-surface-800 px-4">
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="w-14 shrink-0 border-r border-surface-600 bg-surface-700" />
        <div className="w-[380px] shrink-0 border-r border-surface-600 bg-surface-800 p-3 space-y-2">
