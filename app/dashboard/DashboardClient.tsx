    ...
    <div className="min-h-screen bg-surface-900 font-body">
      ...
      <main className="mx-auto max-w-5xl px-6 py-8 space-y-8">
        ...
        <section className="grid grid-cols-3 gap-4">
          {[
            { value: projects.length, label: 'Projects', color: 'text-brand-400' },
            { value: `${lessonsStarted}/6`, label: 'Lessons started', color: 'text-amber-400' },
            { value: publicCount, label: 'Shared publicly', color: 'text-teal-400' },
