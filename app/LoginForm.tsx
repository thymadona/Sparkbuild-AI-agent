  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        disabled={loading}
        className="flex w-full items-center justify-center gap-3 rounded-xl border border-surface-600 bg-surface-800 px-6 py-3 font-medium text-fg-primary transition-colors hover:bg-surface-700 disabled:cursor-not-allowed disabled:opacity-50"
      >
        {loading ? (
